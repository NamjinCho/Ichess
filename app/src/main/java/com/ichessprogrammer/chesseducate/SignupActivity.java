...
import com.ichessprogrammer.chesseducate.usermgmt.ExtraUserPropertyLayout;
import com.ichessprogrammer.chesseducate.widget.KakaoToast;
...
public class SignupActivity extends BaseActivity {
    ...
    private void redirectMainActivity() {
        if(FirstLoadingActivity.OneAct==false) {
            Log.d("디버깅","쳌");
            SharedPreferences preferences = getSharedPreferences("Ichess", Activity.MODE_PRIVATE);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putString("ID",UserProfile.loadFromCache().getId()+"");
            editor.putString("Password","kakaoUser");
            editor.commit();
            startActivity(new Intent(this, FirstLoadingActivity.class));
        }finish();
    }
}
