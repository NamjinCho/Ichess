...
/**
 * 가입 요청 ({@link com.kakao.UserManagement#requestSignup(com.kakao.SignupResponseCallback, java.util.HashMap)}) 호출할 때 넘겨주고 콜백을 받는다.
 * @author MJ
 */
public abstract class SignupResponseCallback extends UserResponseCallback {
     ...
     * {@link com.kakao.ErrorCode#INVALID_PARAM_CODE}, <br/>
     * {@link com.kakao.ErrorCode#INVALID_SCOPE_CODE}, <br/>
     * {@link com.kakao.ErrorCode#NOT_SUPPORTED_API_CODE}, <br/>
     * {@link com.kakao.ErrorCode#INTERNAL_ERROR_CODE}, <br/>
     * {@link com.kakao.ErrorCode#ALREADY_REGISTERED_USER_CODE}, <br/>
     * {@link com.kakao.ErrorCode#NOT_REGISTERED_PROPERTY_KEY_CODE}, <br/>
     * {@link com.kakao.ErrorCode#CLIENT_ERROR_CODE}, <br/>
     * {@link com.kakao.ErrorCode#EXCEED_LIMIT_CODE}, <br/>
     * {@link com.kakao.ErrorCode#KAKAO_MAINTENANCE_CODE}  <br/>
     ...
     * 사용자 콜백 {@link #onSessionClosedFailure(com.kakao.APIErrorResult)}을 호출한다.
     ...
     * 세션의 상태에 따라 {@link #onSessionClosedFailure(com.kakao.APIErrorResult)} 콜백 또는 {@link #onFailure(com.kakao.APIErrorResult)}} 콜백을 호출한다.
    ...
    /**
     * 에러가 발생했을 때의 처리로
     * 세션이 닫혔으면 {@link #onSessionClosedFailure(com.kakao.APIErrorResult)} 콜백을 아니면 {@link #onFailure(com.kakao.APIErrorResult)}} 콜백을 호출한다.
     * @param msg 로깅 메시지
