...
/**
 * 푸시토큰 삭제 요청에 대한 응답 handler로, {@link PushService#deregisterPushToken(com.kakao.PushDeregisterHttpResponseHandler, String)} 또는 {@link PushService#deregisterPushTokenAll(com.kakao.PushDeregisterHttpResponseHandler)}을 호출할 때 넘겨주고 콜백을 받는다.
 * @author MJ
 */
