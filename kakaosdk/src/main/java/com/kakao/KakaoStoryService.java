...
public class KakaoStoryService {
     ...
     * @throws java.io.FileNotFoundException 업로드할 파일이 존재하는 않는 경우 발생한다.
     */
    ...
    /**
     * {@link #requestMultiUpload(com.kakao.KakaoStoryHttpResponseHandler, java.util.List)} 를 사용하도록 한다.
     */
    @Deprecated
    ...
    /**
     * {@link #requestPost(com.kakao.KakaoStoryService.StoryType, com.kakao.KakaoStoryHttpResponseHandler, android.os.Bundle)}를 사용하도록 하낟.
     */
    @Deprecated
