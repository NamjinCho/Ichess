...
import com.kakao.authorization.accesstoken.*;
    ...
    public void requestAccessToken() {
        ...
        HttpTaskManager.execute(new HttpRequestTask<Map>(httpRequest, new AccessTokenCallback(httpRequest, new HttpResponseHandler<Map>() {
            ...
            protected void onHttpSuccess(final Map resultObj) {
                final com.kakao.authorization.accesstoken.AccessToken accessToken = com.kakao.authorization.accesstoken.AccessToken.createFromResponse(resultObj);
                if(accessToken == null)
