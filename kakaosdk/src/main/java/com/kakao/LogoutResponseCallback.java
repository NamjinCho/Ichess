...
/**
 * 로그아웃 요청 ({@link com.kakao.UserManagement#requestLogout(com.kakao.LogoutResponseCallback)}) 호출할 때 넘겨주고 콜백을 받는다.
 * @author MJ
 */
public abstract class LogoutResponseCallback extends UserResponseCallback {
     ...
     * {@link com.kakao.ErrorCode#INVALID_TOKEN_CODE},<br/>
    ...
    /**
     * 강제로 로그아웃을 진행하고 사용자가 정의한 {@link #onFailure(com.kakao.APIErrorResult)}를 호출한다.
